...
# Replace the refresh_weekly_metrics_for_user function with UPSERT version
old_code = '''def refresh_weekly_metrics_for_user(user_id, db_session):
    """
...
new_code = '''def refresh_weekly_metrics_for_user(user_id, db_session):
    """
...
if old_code in content:
    ...
    print("Please manually replace refresh_weekly_metrics_for_user with the UPSERT version.")
